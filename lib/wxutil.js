...
//根据appId和sessionKey还原加密数据
var decryptData = function (appId, sessionKey, encryptedData, iv) {
    console.log(appId, sessionKey, encryptedData, iv,"22222");
    var sessionKey = new Buffer(sessionKey, 'base64');
    console.log(appId, sessionKey, encryptedData, iv,"3333");
    encryptedData = new Buffer(encryptedData, 'base64')
    console.log(appId, sessionKey, encryptedData, iv,"4444");
    iv = new Buffer(iv, 'base64')
    console.log(appId, sessionKey, encryptedData, iv,"5555");
